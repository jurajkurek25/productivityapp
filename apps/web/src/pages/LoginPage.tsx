...
export function LoginPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      setError(err instanceof ApiError ? t.auth.invalidCredentials : t.auth.somethingWrong);
    } finally {
      setSubmitting(false);
    }
  }
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-brand-50/60 via-slate-50 to-slate-50 px-4">
      <div className="w-full max-w-sm">
        <div className="mb-6 flex flex-col items-center">
          ...
          <h1 className="font-display text-xl font-bold text-slate-900">{t.auth.welcomeBack}</h1>
