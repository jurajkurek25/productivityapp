...
export const t = {
  ...
  todayFocus: {
    ...
    empty: "Na dnes nemáš naplánované žiadne otvorené úlohy.",
    doNow: "Urob teraz",
    protectTime: "Naplánuj si na to čas",
    quickWin: "Vybav rýchlo",
    reconsider: "Zváž, či je to treba",
  },
  weeklyReview: {
  ...
  goalDetail: {
    ...
    woopTitle: "Prekážka a plán (WOOP)",
    woopSubtitle: "Pomenuj si, čo ťa zvyčajne zastaví, a vopred si naplánuj, ako na to zareaguješ.",
    woopObstacleLabel: "Prekážka",
    woopObstaclePlaceholder: "napr. Večer som príliš unavený/á",
    woopPlanLabel: "Ak nastane prekážka, urobím",
    woopPlanPlaceholder: "napr. …tak si to preložím na ráno pred prácou",
    woopEmpty: "Zatiaľ nemáš nastavenú prekážku ani plán.",
    woopSetup: "Nastaviť WOOP",
    keyResultTitle: "Merateľný výsledok (OKR)",
    keyResultEmpty: "Zatiaľ nemáš nastavený merateľný výsledok pre tento cieľ.",
    keyResultSetup: "Nastaviť výsledok",
    keyResultTargetLabel: "Cieľové množstvo",
    keyResultTargetPlaceholder: "napr. 50000",
    keyResultUnitLabel: "Jednotka",
    keyResultUnitPlaceholder: "napr. slov, kníh, zákazníkov",
    keyResultProgress: (current: number, target: number, unit: string) => `${current} / ${target} ${unit}`,
    keyResultMet: "Dosiahnuté",
    keyResultAddPlaceholder: "napr. 5",
    keyResultAdd: "Pridať",
  },
  recurrenceLabel: {
    once: "Jednorazovo",
